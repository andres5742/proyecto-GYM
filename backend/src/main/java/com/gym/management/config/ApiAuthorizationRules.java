...
public final class ApiAuthorizationRules {
    ...
    public static void apply(
        ...
        auth.requestMatchers(HttpMethod.OPTIONS, "/**").permitAll()
                ...
                .hasAnyRole("ADMIN", "SUPER_ADMIN", "TRAINER")
                .requestMatchers("/api/billing/cash-registers", "/api/billing/cash-registers/**")
                .hasAnyRole("ADMIN", "SUPER_ADMIN", "TRAINER")
                .requestMatchers("/api/auth/**", "/api/health/**")
                .permitAll()
                .requestMatchers(HttpMethod.DELETE, "/api/shift-handovers/**")
                .hasRole("SUPER_ADMIN")
                .requestMatchers("/api/shift-handovers", "/api/shift-handovers/**")
                .hasAnyRole("ADMIN", "SUPER_ADMIN", "TRAINER")
                ...
                .requestMatchers(HttpMethod.DELETE, "/api/access/logs/*")
                .hasAnyRole("ADMIN", "SUPER_ADMIN", "TRAINER")
                .requestMatchers(HttpMethod.POST, "/api/access/logs/*/revoke")
                .hasAnyRole("ADMIN", "SUPER_ADMIN", "TRAINER")
                ...
                .hasAnyRole("ADMIN", "SUPER_ADMIN")
                .requestMatchers("/api/billing/payment-account-settings/**")
                .hasAnyRole("ADMIN", "SUPER_ADMIN")
