...
@Entity
@Table(
        name = "member_biometric_credentials",
        uniqueConstraints = {
            @UniqueConstraint(columnNames = {"member_id", "credential_type"}),
...
@AllArgsConstructor
@Builder
public class MemberBiometricCredential {
    ...
    /** ID de usuario en el lector (huella, rostro, etc.). */
