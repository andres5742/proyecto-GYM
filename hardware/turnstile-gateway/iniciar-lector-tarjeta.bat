...
set GATE_SYNC_KEY=%ACCESS_DEVICE_KEY%
set GATE_HTTP_HOST=0.0.0.0
...
echo Re-seguro ATP: %TURNSTILE_RELOCK_CHARS%
if defined TURNSTILE_UNLOCK_FOLLOW_CHAR (
  echo Apertura ATP: %TURNSTILE_UNLOCK_CHAR% + %TURNSTILE_UNLOCK_FOLLOW_CHAR%
) else (
  echo Apertura ATP: %TURNSTILE_UNLOCK_CHAR%
)
