...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
  ...
  "$dir='%CD%';" ^
  "$files=@('serial_card_reader.py','iniciar-lector-tarjeta.bat','iniciar-lector-debug.bat','iniciar-lector-115200.bat','detener-lector-tarjeta.bat','requirements-serial.txt');" ^
